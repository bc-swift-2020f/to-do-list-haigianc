...
//  ToDo List
//
//  Created by Claudine Haigian on 9/26/20.
    ...
    func setNotifications(){
        ...
        for index in 0..<toDoItems.count{
            if toDoItems[index].reminderSet{
                ...
                toDoItems[index].notificationID = setCalendarNotificaion(title: toDoItem.name, subtitle: "", body: toDoItem.notes, badgeNumber: nil, sound: .default, date: toDoItem.date)
            }
        }
    }
    
    func setCalendarNotificaion(title: String, subtitle: String, body: String, badgeNumber: NSNumber?, sound: UNNotificationSound, date: Date) -> String{
        //create content
